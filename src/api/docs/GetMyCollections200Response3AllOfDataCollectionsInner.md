# GetMyCollections200Response3AllOfDataCollectionsInner
...
```typescript
import { GetMyCollections200Response3AllOfDataCollectionsInner } from './api';

const instance: GetMyCollections200Response3AllOfDataCollectionsInner = {
    collectionId,
    title,
    description,
    author,
