...
**userProfileImage** | **string** | 작성자 프로필 이미지 URL | [optional] [default to undefined]
**rating** | **number** | 별점 (0.5 ~ 5.0) | [default to undefined]
**title** | **string** | 리뷰 제목 | [optional] [default to undefined]
**content** | **string** | 리뷰 내용 미리보기 | [optional] [default to undefined]
**likeCount** | **number** | 좋아요 개수 | [optional] [default to undefined]
**commentCount** | **number** | 댓글 개수 | [optional] [default to undefined]
