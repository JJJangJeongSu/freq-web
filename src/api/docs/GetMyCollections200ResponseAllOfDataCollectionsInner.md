# GetMyCollections200ResponseAllOfDataCollectionsInner
...
```typescript
import { GetMyCollections200ResponseAllOfDataCollectionsInner } from './api';

const instance: GetMyCollections200ResponseAllOfDataCollectionsInner = {
    collectionId,
    title,
    description,
    author,
