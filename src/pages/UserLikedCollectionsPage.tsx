...
import { useUserLikedCollectionsPaginated } from "../hooks/useUserLikedCollectionsPaginated";

export function UserLikedCollectionsPage() {
  ...
  const {
    ...
    refresh,
    hasMore
  } = useUserLikedCollectionsPaginated(userId, 'infinite');
      ...
      <div className="p-3 md:p-4">
        {filteredCollections.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-body-medium text-on-surface-variant">
              {searchQuery ? "검색 결과가 없습니다." : "아직 좋아요한 컬렉션이 없습니다."}
            </p>
          </div>
        ) : (
          <>
